...
paralist.raw_server     = '/Volumes/xujiahua/Twins/Origin/Twins_Org';
paralist.data_type      = 'nii';

paralist.imagefilter    = 'swcar'; 
paralist.NFRAMES = 180;
paralist.NUMTRUNC = [5,5]%[8,2];
...
paralist.wm_csf_roi_file{1} = '/Users/xujiahua/Documents/Code/spm8_scripts/rsFC_network/white_mask_p08_d1_e1_roi.mat';
paralist.wm_csf_roi_file{2} = '/Users/xujiahua/Documents/Code/spm8_scripts/rsFC_network/csf_mask_p08_d1_e1_roi.mat'; 

% Please specify file name holding subjects to be analyzed
% For one subject list files. For eg.,
paralist.subjlist_file  = {'180TR.txt'}; 
 
paralist.ROI_dir        = '/Volumes/xujiahua/Twins/Origin/SeedToSeed/ROI_Orginal0621_mat';
paralist.output_folder  = '/Volumes/xujiahua/Twins/Origin/SeedToSeed/Results_180';
% get roiname:
