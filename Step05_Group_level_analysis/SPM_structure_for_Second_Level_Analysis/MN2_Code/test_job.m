...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Users/xujiahua/Desktop/Twins/MN2'};
...
%%
mn2=database(:,9)
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov.c = cell2mat(mn2);
%%
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov.cname = 'MN2';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov.iCC = 1;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.incint = 1;
%%
LES2=database(:,10)
matlabbatch{1}.spm.stats.factorial_design.cov(1).c =cell2mat(LES2);
%%
matlabbatch{1}.spm.stats.factorial_design.cov(1).cname = 'LES2';
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'MN2';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 0 0 0 1];
